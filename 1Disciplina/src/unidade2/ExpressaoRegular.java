...
public class ExpressaoRegular {
	...
	public static void main(String[] args) {
	    ...
	    /*************** Modificadores(Modificador ignora letras maiúsculas e minúsculas) **********************/
	        
	        boolean sobreNome = "Silveira".matches("(?i)silveira");
			System.out.println("Retorno = "+sobreNome);
		
		/**************** Modificadores(Validações de caracteres)***************/
	    ...
	    /**************** Modificadores(Exemplos de ocorrências)***************/
	    ...
	    /**************** Quantificadores (Demonstração dos quantificadores)***************/  
	        ...
	        /**************** Metacaracteres de fronteira (Demonstração dos metacaracteres)***************/  
	        ...
	        //Termina com 322
	        //O ponto (.) Começa com qualquer caractere e busca 0 ou mais caracteres finalizando com o num 322
	        ...
	        /**************** Agrupadores (Demonstração de agrupadores)***************/
	        
	      //Busca qualquer letra de a até z - faz diferença utilizar maiúsculas e minúsuculas
